...
public class Listar_Up_Cad extends javax.swing.JFrame {
    ...
    public void estilizarTelaListaUpCad() {
        ...
        jPanel3.setBackground(corCard);
            ...
            JTable[] tables = {jTable1};
            for (JTable tbl : tables){
                tbl.setBackground(corInput);
                tbl.setForeground(Color.WHITE);
                tbl.setBorder(BorderFactory.createEmptyBorder(8,15,8,15));
                tbl.setFillsViewportHeight(true);


            }

            JScrollPane[] panels = {jScrollPane1, jScrollPane2};
            for (JScrollPane tnl : panels){
                tnl.setBackground(corInput);
                tnl.setForeground(Color.WHITE);
                tnl.setBorder(BorderFactory.createEmptyBorder(8,15,8,15));
            }

           JButton[] btns = {voltarBtn, upBtn};
        ...
        upBtn.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                upBtn.setBackground(corBtn.darker());
            }

            public void mouseExited(java.awt.event.MouseEvent evt) {
                upBtn.setBackground(corBtn);
            }
        });
    ...
    private void initComponents() {
        ...
        jPanel3.setPreferredSize(new java.awt.Dimension(950, 360));
