...
public class Atualizar_Cadastro extends javax.swing.JFrame {
    ...
    // Construtor vazio para o método main (se necessário para testes visuais)
    private Atualizar_Cadastro() {
        initComponents();
        estilizarTelaAtualizarCadastrar();
    }

    public Atualizar_Cadastro(String CPF, String cpf) {
        ci = ClienteDAO.buscarPorCPF(CPF); 
        this.cpf = cpf;
        ...
        nomeTxt.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                if (evt.getKeyCode() == KeyEvent.VK_ENTER) cadBtnActionPerformed(null);
                if (evt.getKeyCode() == KeyEvent.VK_ESCAPE) voltarBtnActionPerformed(null);
            }
        });
    ...
    public void estilizarTelaAtualizarCadastrar() {
        ...
        voltarBtn.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) { voltarBtn.setBackground(corBtn.darker()); }
            public void mouseExited(java.awt.event.MouseEvent evt) { voltarBtn.setBackground(corBtn); }
        });

        cadBtn.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) { cadBtn.setBackground(corBtn.darker()); }
            public void mouseExited(java.awt.event.MouseEvent evt) { cadBtn.setBackground(corBtn); }
        });
        ...
        jPanel3.setBorder(new AbstractBorder() {
            ...
            public void paintBorder(Component c, Graphics g, int x, int y, int width, int height) {
                ...
                for (int i = 0; i < shadowSize; i++) {
                    ...
                    g2.drawRoundRect(x + i, y + i, width - (i * 2) - 1, height - (i * 2) - 1, 50, 50);
                }
                g2.dispose();
            }
            @Override
            public Insets getBorderInsets(Component c) { return new Insets(5, 5, 10, 10); }
        });
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Atualizar Cadastro"); // Texto alterado conforme pedido (lógica visual)
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(cityTxt))) // Flexivel
                            
                    // LINHA 4: CPF | Telefone | Botao
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private boolean insert(){
        ...
        estCb.setSelectedItem(ci.getEstado());
