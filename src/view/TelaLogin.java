...
public class TelaLogin extends javax.swing.JFrame {
         ...
         loginTxt.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
                    entrarBtnActionPerformed(null); // Chama o método de login quando Enter é pressionado
                }
            }
        });
    ...
    private void initComponents() {
        ...
        jLabel3.setFont(new java.awt.Font("Yu Gothic UI Semilight", 2, 14)); // NOI18N
        jLabel3.setText("Senha");

        senhaTxt.setToolTipText("Insira sua senha");

        entrarBtn.setFont(new java.awt.Font("Yu Gothic UI Semilight", 2, 14)); // NOI18N
